...
private static final Logger logger = LogManager.getLogger(EmployeServiceImpl.class);
	...
	public void testAjouterEntreprise() {
		...
		assertEquals(1, entrepriseServiceImpl.ajouterEntreprise(new Entreprise("TestBouhmid","Bouhmid")));
	...
	public void testAjouterDepartement() {
		...
		assertEquals(1, employeServiceImpl.ajouterDepartement(new Departement("Departement Informatique")));
	}
}
